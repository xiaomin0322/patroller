...
import com.preapm.agent.plugin.interceptor.filter.HttpRequestFilter;
import com.preapm.agent.plugin.interceptor.filter.HttpResponseFilter;
...
public class HttpClientUtil {
	...
	public static String doGet(String url, Map<String, String> param,RequestConfig config) {
		...
		// 创建Httpclient对象
		CloseableHttpClient httpclient = HttpClients.custom().addInterceptorFirst(new HttpRequestFilter()).addInterceptorFirst(new HttpResponseFilter())
				.build();
